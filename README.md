...
No subscriptions. No plugins. No accounts.
...
📤 Exporting to Final Cut Pro
	...
	3.	In Final Cut Pro:
	4.	Go to File → Import → XML
	4.	Select the exported file

Your captions will appear as title clips in a new project or event.
To use them in an existing timeline, select all caption titles, copy them, and paste them into your working timeline.
